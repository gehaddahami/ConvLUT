...
# The models below are for the Linear MLP MNIST processing 
...
# The models below are for the 1D-CNN MNIST processing 
...
class QuantizedMNIST_NEQ(nn.Module):
    ...
    def pytorch_forward(self, x): 
        ...
        for i, layer in enumerate(self.module_list): 
            # print('shape of the input tensor is: ', x.shape)
            x = layer(x)
